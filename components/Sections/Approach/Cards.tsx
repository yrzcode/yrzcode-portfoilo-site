		...
		<>
			<div className="cards-container">
				...
				<Card
					...
					description="Based on the agreed plan, a tailored solution is designed and developed using modern technologies, with a focus on performance, accessibility, and visual clarity."
				...
				<Card
					...
					description="Comprehensive testing ensures the final product works seamlessly across devices and browsers. The completed work is then delivered, ready for launch and real-world use."
...
const Card = ({
	...
	return (
        ...
        text-black mt-6 mb-4 font-bold group-hover/canvas-card:text-white 
        group-hover/canvas-card:-translate-y-2 transition duration-200"
				>
					{description}
				</h2>
